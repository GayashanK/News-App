//
//  FranceArticlesViewController.swift
//  PracticleTest
//
...
class FranceArticlesViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        if Reachability.isInternetAvailable() {
            self.getArticles(countryCode: CountryCodes.France.rawValue)
        } else {
...
extension FranceArticlesViewController: UITableViewDelegate, UITableViewDataSource {
