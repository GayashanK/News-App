//
//  GermanArticlesViewController.swift
//  PracticleTest
//
...
class GermanArticlesViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        if Reachability.isInternetAvailable() {
            self.getArticles(countryCode: CountryCodes.Germany.rawValue)
        } else {
...
extension GermanArticlesViewController: UITableViewDelegate, UITableViewDataSource {
